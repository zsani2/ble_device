...
// USART0 CTS on PF2
#define SL_UARTDRV_USART_VCOM_CTS_PORT           gpioPortF
#define SL_UARTDRV_USART_VCOM_CTS_PIN            2
#define SL_UARTDRV_USART_VCOM_CTS_LOC            22

// USART0 RTS on PF3
#define SL_UARTDRV_USART_VCOM_RTS_PORT           gpioPortF
#define SL_UARTDRV_USART_VCOM_RTS_PIN            3
#define SL_UARTDRV_USART_VCOM_RTS_LOC            22
