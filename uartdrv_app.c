...
void uartdrv_app_init(void)
{
  ...
  UARTDRV_Transmit(sl_uartdrv_usart_vcom_handle, (uint8_t *)str1, strlen(str1), UART_tx_callback);
  // Non-blocking receive
  UARTDRV_Receive(sl_uartdrv_usart_vcom_handle, &rx_byte, 1, UART_rx_callback);
}
